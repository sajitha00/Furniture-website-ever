    ...
    <div className="margin-y">
      ...
      <div className="margin-y grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="bg-[#EBEBEB] rounded-[36px] p-10 text-center lg:text-left">
          <div className="flex justify-center lg:justify-start h-9">
            <img
              src="/image/Icon/one.png"
              alt="Section05Icon1"
              width={40}
              height={40}
            />
          ...
          <div>
            ...
            <div className="description text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px]">
              We collaborate with homeowners and designers to turn unique ideas
              into blueprints.
            </div>
          </div>
        </div>
        <div className="bg-[#EBEBEB] rounded-[36px] p-7 text-center lg:text-left">
          ...
          <div>
            ...
            <div className="description text-[14px] sm:text-[15px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px]">
              Every curve and joint is meticulously handcrafted using
        ...
        <div className="bg-[#EBEBEB] rounded-[36px] p-7 text-center lg:text-left">
          ...
          <div>
            ...
            <div className="description text-[14px]  sm:text-[15px] md:text-[16px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px]">
              Each piece is polished, refined, and quality-checked to
              perfection.
            </div>
          </div>
        </div>
